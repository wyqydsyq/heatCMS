 ...
 * this is the file that basically builds the entire front-end aspect of all pages.
 * 
 ...
 */
/*
 * TODO: All the variables in this file should _really_ be in an array rather
 *       than bare variables to prevent issues with templates and people using
 *       them (for example they could decide to use a variable called $css,
 *       which they wouldn't expect to already be in use)
 */
